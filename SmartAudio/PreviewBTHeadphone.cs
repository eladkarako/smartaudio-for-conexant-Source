namespace SmartAudio
{
    ...
    public class PreviewBTHeadphone : UserControl, IHDAudioPreview, IComponentConnector
    {
        ...
        public void InitializeComponent()
        {
            if (!this._contentLoaded)
            {
                ...
                Uri resourceLocator = new Uri("/SmartAudio;component/previewbtheadphone.xaml", UriKind.Relative);

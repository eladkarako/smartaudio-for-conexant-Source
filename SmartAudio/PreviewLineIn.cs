namespace SmartAudio
{
    ...
    public class PreviewLineIn : UserControl, IHDAudioPreview, IComponentConnector
    {
        ...
        public void InitializeComponent()
        {
            if (!this._contentLoaded)
            {
                ...
                Uri resourceLocator = new Uri("/SmartAudio;component/previewlinein.xaml", UriKind.Relative);

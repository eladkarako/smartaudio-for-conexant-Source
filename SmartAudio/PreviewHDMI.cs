namespace SmartAudio
{
    ...
    public class PreviewHDMI : UserControl, IHDAudioPreview, IComponentConnector
    {
        ...
        public void InitializeComponent()
        {
            if (!this._contentLoaded)
            {
                ...
                Uri resourceLocator = new Uri("/SmartAudio;component/previewhdmi.xaml", UriKind.Relative);
